...
void ConjugateGradient::sendAndBorrowValues_q()
{
    ...
    std::vector<double> p_bottom(discretization_->pIEnd() - discretization_->pIBegin() + 1);
    std::vector<double> p_top(discretization_->pIEnd() - discretization_->pIBegin() + 1);
    std::vector<double> p_left(discretization_->pJEnd() - discretization_->pJBegin() + 1);
    std::vector<double> p_right(discretization_->pJEnd() - discretization_->pJBegin() + 1);
