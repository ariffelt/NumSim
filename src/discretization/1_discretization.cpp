 ...
 */
Discretization::Discretization(std::shared_ptr<Partitioning> partitioning, std::array<int, 2> nCells, std::array<double, 2> meshWidth) : StaggeredGrid(partitioning, nCells, meshWidth)
{
}
