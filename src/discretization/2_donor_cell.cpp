...
*/
DonorCell::DonorCell(const std::shared_ptr<Partitioning> partitioning, std::array<double, 2> meshWidth, double alpha) : Discretization(partitioning, meshWidth), alpha_(alpha)
{
}
